...
# Exit:   0 = GATE GREEN (all six stages)
#         N = 1..6, the first red stage
...
stage2_stdlib() {
    bash "$STDLIB_SCRIPTS/build_stdlib.sh" --clean && bash "$STDLIB_SCRIPTS/build_stdlib.sh"
}
stage3_iiis1() {
...
log "GATE GREEN: full toolchain regenerated from clean (logs: $LOGDIR)"
exit 0
