...
#
# Build iii-line: GAMMA-1, THE EXACT LINE -- geometry re-founded on the
...
# NO gate, NO KAT: xl_selfprove (arms 110..115) at every invocation.
#
...
BIN="$OUT_DIR/iii-line$BIN_SUFFIX"
log "link -> $BIN"
rc=1
