...
A2_LIST=("indep_toolchain:$IND_DIR" "indep_ops:$IND_DIR" "indep_bignum:$IND_DIR" "sq07_width:$SQ_DIR" "sq08_mixed:$SQ_DIR" "sq09_mixsign:$SQ_DIR" "sq10_renorm:$SQ_DIR" "sq12_comptime:$SQ_DIR" "sq13_varinit:$SQ_DIR" "sq14_localarr:$SQ_DIR" "sq15_crt:$SQ_DIR" "sq16_ptr:$SQ_DIR")
