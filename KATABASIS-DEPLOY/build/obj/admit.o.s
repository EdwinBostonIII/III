...
L_str_4:
    ...
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_katabasis_gate_admit
L_p_katabasis_gate_admit:
    .seh_proc L_p_katabasis_gate_admit
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_katabasis_cycle_seal_verify
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_katabasis_gate_decide_term
    addq $32, %rsp
    pushq %rax
    popq %rax
    pushq %rax
