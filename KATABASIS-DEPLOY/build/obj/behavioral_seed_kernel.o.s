...
# Output binary: iiis-0.sys
    ...
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_bsk_logic_faithful
L_p_bsk_logic_faithful:
    .seh_proc L_p_bsk_logic_faithful
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_39:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_bsk_arith_faithful
L_p_bsk_arith_faithful:
    .seh_proc L_p_bsk_arith_faithful
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
