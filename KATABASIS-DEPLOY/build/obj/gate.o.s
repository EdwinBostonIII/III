...
L_p_KG_REJECT_HEXAD:
    .quad 0x3
L_p_KG_REJECT_IRREVERSIBLE:
    .quad 0x4
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_katabasis_gate_decide_term
L_p_katabasis_gate_decide_term:
    .seh_proc L_p_katabasis_gate_decide_term
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    testq %rax, %rax
    jz L_if_end_1
    movq L_p_KG_REJECT_SEAL(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    pushq %rax
...
L_if_end_1:
    ...
    testq %rax, %rax
    jz L_if_end_3
    movq L_p_KG_REJECT_CAP(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    pushq %rax
...
L_if_end_3:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_katabasis_cycle_admit
    addq $32, %rsp
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    ...
    testq %rax, %rax
    jz L_if_end_5
    movq L_p_KG_REJECT_HEXAD(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    pushq %rax
...
L_if_end_5:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_katabasis_cycle_has_inverse
    addq $32, %rsp
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    ...
    testq %rax, %rax
    jz L_if_end_7
    movq L_p_KG_REJECT_IRREVERSIBLE(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    pushq %rax
