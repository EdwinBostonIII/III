...
L_p_wdm_set_status:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_create
L_p_floor_create:
    .seh_proc L_p_floor_create
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_complete_request
    addq $32, %rsp
    pushq %rax
    popq %rax
    movabsq $0x0, %rax
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_close
L_p_floor_close:
    .seh_proc L_p_floor_close
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_gate_decide
L_p_floor_gate_decide:
    .seh_proc L_p_floor_gate_decide
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_1:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_gate_self
L_p_floor_gate_self:
    .seh_proc L_p_floor_gate_self
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_alloc_contig
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -16(%rbp)
...
L_if_end_3:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_write_guest_request
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq -24(%rbp), %rax
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_pin_core
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -32(%rbp)
    subq $32, %rsp
    callq L_p_iii_kfo_raise_dispatch
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_writemsr
    addq $32, %rsp
    pushq %rax
    popq %rax
    movabsq $0xc0010117, %rax
    pushq %rax
    movq -24(%rbp), %rax
    pushq %rax
    movabsq $0x1000, %rax
...
L_for_end_5:
    ...
    movq -88(%rbp), %rax
    pushq %rax
    movabsq $0xffffffffffffefff, %rax
    pushq %rax
    popq %rcx
    popq %rax
    andq %rcx, %rax
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_gate_loop
L_p_floor_gate_loop:
    .seh_proc L_p_floor_gate_loop
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_13:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_write_guest_loop
    addq $32, %rsp
    pushq %rax
    popq %rax
    movabsq $0x1, %rax
...
L_for_end_15:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_npt_loop
L_p_floor_npt_loop:
    .seh_proc L_p_floor_npt_loop
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_for_end_27:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_vmrun_diag
L_p_floor_vmrun_diag:
    .seh_proc L_p_floor_vmrun_diag
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_39:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_validated_code
L_p_floor_validated_code:
    .seh_proc L_p_floor_validated_code
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_67:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_ioctl
L_p_floor_ioctl:
    .seh_proc L_p_floor_ioctl
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_floor_validated_code
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
...
L_if_end_113:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_floor_unload
L_p_floor_unload:
    .seh_proc L_p_floor_unload
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    addq $32, %rsp
    subq $32, %rsp
    callq L_p_iii_kfo_delete_symlink
    addq $32, %rsp
    pushq %rax
    popq %rax
    leaq L_p_G_FDEVOBJ(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_delete_device
    addq $32, %rsp
    pushq %rax
    popq %rax
    movabsq $0x0, %rax
...
DriverEntry:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_p_iii_kfo_create_device
    addq $32, %rsp
    pushq %rax
    popq %rax
    leaq L_p_floor_unload(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    movq %rdx, (%rax,%rcx,8)
    subq $32, %rsp
    callq L_p_iii_kfo_create_symlink
    addq $32, %rsp
    pushq %rax
    popq %rax
    movabsq $0x0, %rax
