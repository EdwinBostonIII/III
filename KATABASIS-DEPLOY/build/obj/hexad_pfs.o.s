...
L_p_HXP_PFS_COUNT:
    .quad 0x7
    .section .bss
    .global L_p_HXP_PILLARS
L_p_HXP_PILLARS:
    .zero 48
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p__hxp_fill
L_p__hxp_fill:
    .seh_proc L_p__hxp_fill
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_11:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_iii_hexad_pfs
L_p_iii_hexad_pfs:
    .seh_proc L_p_iii_hexad_pfs
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_if_end_13:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_iii_hexad_pfs_count
L_p_iii_hexad_pfs_count:
    .seh_proc L_p_iii_hexad_pfs_count
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_iii_hexad_pfs_kind
L_p_iii_hexad_pfs_kind:
    .seh_proc L_p_iii_hexad_pfs_kind
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
...
L_for_end_15:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_iii_hexad_pfs_name
L_p_iii_hexad_pfs_name:
    .seh_proc L_p_iii_hexad_pfs_name
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
