...
L_if_end_25:
    ...
    .section .text,"xr"  /* PE/COFF Â§6 */
    /* IRQL_REQUIRES_MAX(2) */
    .global L_p_iii_hexad_reach_selftest
L_p_iii_hexad_reach_selftest:
    .seh_proc L_p_iii_hexad_reach_selftest
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    subq $1024, %rsp
    ...
    popq %rax
    subq $32, %rsp
    callq L_p_iii_hexad_reachable_count
    addq $32, %rsp
    pushq %rax
    movabsq $0x90, %rax
    pushq %rax
