...
# gate-admit dependency closure, in deterministic order (leaves first).
MODS=(
...
echo "[1] cg_r0 -> .o : driver + kernel cpufeat shim + ${#MODS[@]} closure modules"
...
OBJS=("$O/gate_resident.o" "$O/cpufeat_kernel.o")
