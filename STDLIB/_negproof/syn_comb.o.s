...
L_if_end_25:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "_cb_abstract_naive"
    .text
    .seh_proc L__cb_abstract_naive
L__cb_abstract_naive:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_43:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cb_compile_naive"
    .text
    .global cb_compile_naive
    .seh_proc cb_compile_naive
cb_compile_naive:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
