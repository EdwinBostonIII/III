...
L_AI_K_IF:
    .quad 0xf
    .section .iii.ring3,"n"
    .asciz "_ai_resolve_pair"
    .text
    .seh_proc L__ai_resolve_pair
L__ai_resolve_pair:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
