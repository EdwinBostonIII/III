...
L_JSON_COUNT:
    .quad 0x0
    .global L_JSON_INPUT_BASE
L_JSON_INPUT_BASE:
    .quad 0x0
    .global L_JSON_INPUT_LEN
L_JSON_INPUT_LEN:
    .quad 0x0
    .global L_JSON_INPUT_POS
L_JSON_INPUT_POS:
    .quad 0x0
    .global L_JSON_ARENA
L_JSON_ARENA:
...
L_JSON_ARRAY_SCRATCH:
    .zero 131072
    .global L_JSON_OBJECT_SCRATCH
L_JSON_OBJECT_SCRATCH:
    .zero 262144
    .global L_JSON_NUM_BUF
L_JSON_NUM_BUF:
    .zero 192
    .section .iii.ring3,"n"
...
L_json_alloc_slot:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movl L_JSON_COUNT(%rip), %eax
    pushq %rax
    movl L_JSON_MAX_NODES(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_loop_end_9:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_JSON_INPUT_BASE(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rax, L_JSON_INPUT_LEN(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rax, L_JSON_INPUT_POS(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rax, L_JSON_ARENA(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movl %eax, L_JSON_DEPTH(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movl %eax, L_JSON_ERROR(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rax, L_JSON_ERROR_POS(%rip)
...
L_if_end_51:
    ...
    movl -16(%rbp), %eax
    pushq %rax
    movzbq L_JSON_KIND_NULL(%rip), %rax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
...
L_if_end_313:
    ...
    popq %rax
    movq %rax, -40(%rbp)
    leaq L_JSON_ARRAY_SCRATCH(%rip), %rax
    pushq %rax
    movl -40(%rbp), %eax
    pushq %rax
    movq -32(%rbp), %rax
...
L_if_end_345:
    ...
    popq %rax
    movq %rax, -56(%rbp)
    leaq L_JSON_OBJECT_SCRATCH(%rip), %rax
    pushq %rax
    movl -56(%rbp), %eax
    pushq %rax
    movq -32(%rbp), %rax
...
L_if_end_363:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_last_error"
    .text
    .global json_last_error
    .seh_proc json_last_error
json_last_error:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_last_error_pos"
    .text
    .global json_last_error_pos
    .seh_proc json_last_error_pos
json_last_error_pos:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_369:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_string_base"
    .text
    .global json_string_base
    .seh_proc json_string_base
json_string_base:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_373:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_string_len"
    .text
    .global json_string_len
    .seh_proc json_string_len
json_string_len:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_377:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_array_len"
    .text
    .global json_array_len
    .seh_proc json_array_len
json_array_len:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_381:
    ...
    .asciz "json_array_at"
    .text
    .global json_array_at
    .seh_proc json_array_at
json_array_at:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_387:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_object_len"
    .text
    .global json_object_len
    .seh_proc json_object_len
json_object_len:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_json_object_pair_load:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_object_key_at"
    .text
    .global json_object_key_at
    .seh_proc json_object_key_at
json_object_key_at:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_397:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_object_value_at"
    .text
    .global json_object_value_at
    .seh_proc json_object_value_at
json_object_value_at:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_403:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_object_get"
    .text
    .global json_object_get
    .seh_proc json_object_get
json_object_get:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_483:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "json_node_count"
    .text
    .global json_node_count
    .seh_proc json_node_count
json_node_count:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
