...
L_ENTROPY_ID_LEN:
    .quad 0x20
L_ENTROPY_INVALID_SLOT:
    .quad 0xffffffff
    .section .bss
    .global L_ENTROPY_LIVE
L_ENTROPY_LIVE:
    .zero 2048
    .global L_ENTROPY_PATH_ID
L_ENTROPY_PATH_ID:
    .zero 65536
    .global L_ENTROPY_BUF
L_ENTROPY_BUF:
    .zero 131072
    .global L_ENTROPY_BUF_HEAD
L_ENTROPY_BUF_HEAD:
    .zero 2048
    .global L_ENTROPY_BUF_LEN
L_ENTROPY_BUF_LEN:
    .zero 2048
    .global L_ENTROPY_BASELINE
L_ENTROPY_BASELINE:
    .zero 131072
...
L_ENTROPY_WIT_SPEC:
    .zero 512
    .global L_ENTROPY_WIT_BUF
L_ENTROPY_WIT_BUF:
    .zero 2368
    .global L_ENTROPY_WIT_HASH
L_ENTROPY_WIT_HASH:
    .zero 256
    .section .data
    .global L_ENTROPY_OMEGA
L_ENTROPY_OMEGA:
    .quad 0x0
    .global L_ENTROPY_INITED
L_ENTROPY_INITED:
    .quad 0x0
    .section .bss
    .global L_ENTROPY_KAT_ID
L_ENTROPY_KAT_ID:
    .zero 256
    .global L_ENTROPY_KAT_SPEC
L_ENTROPY_KAT_SPEC:
    .zero 512
    .global L_ENTROPY_KAT_SPEC2
L_ENTROPY_KAT_SPEC2:
    .zero 512
    .global L_ENTROPY_KAT_H1
L_ENTROPY_KAT_H1:
    .zero 256
    .global L_ENTROPY_KAT_H2
L_ENTROPY_KAT_H2:
    .zero 256
    .section .iii.ring3,"n"
...
L_loop_top_8:
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_ENTROPY_BUF_HEAD(%rip), %rax
    pushq %rax
    movl -8(%rbp), %eax
    pushq %rax
    movabsq $0x0, %rax
...
L_loop_end_9:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_ENTROPY_OMEGA(%rip)
    movabsq $0x1, %rax
    pushq %rax
    popq %rax
    movb %al, L_ENTROPY_INITED(%rip)
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_register_path"
    .text
    .global entropy_register_path
    .seh_proc entropy_register_path
entropy_register_path:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_entropy_umod_prime:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_sample"
    .text
    .global entropy_sample
    .seh_proc entropy_sample
entropy_sample:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_21:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_spectrum"
    .text
    .global entropy_spectrum
    .seh_proc entropy_spectrum
entropy_spectrum:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_23:
    ...
    popq %rax
L_if_end_25:
    movzbq L_ENTROPY_INITED(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
...
L_loop_end_35:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_set_baseline"
    .text
    .global entropy_set_baseline
    .seh_proc entropy_set_baseline
...
L_loop_end_43:
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_ENTROPY_WIT_HASH(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_distance"
    .text
    .global entropy_distance
    .seh_proc entropy_distance
entropy_distance:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_49:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_baseline_matches"
    .text
    .global entropy_baseline_matches
    .seh_proc entropy_baseline_matches
entropy_baseline_matches:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_67:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_witness"
    .text
    .global entropy_witness
    .seh_proc entropy_witness
entropy_witness:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_71:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "entropy_selftest"
    .text
    .global entropy_selftest
    .seh_proc entropy_selftest
entropy_selftest:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
