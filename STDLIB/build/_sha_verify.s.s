...
L_sha_rotr:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "_sha_sched4_scalar"
    .text
    .seh_proc L__sha_sched4_scalar
L__sha_sched4_scalar:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "_sha_sched4_avx512"
    .text
    .seh_proc L__sha_sched4_avx512
L__sha_sched4_avx512:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_7:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_sched_force"
    .text
    .global sha256_sched_force
    .seh_proc sha256_sched_force
sha256_sched_force:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
sha256_init:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_SHA_BITS(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movl %eax, L_SHA_BUFLEN(%rip)
    movabsq $0x1, %rax
    pushq %rax
    popq %rax
    movb %al, L_SHA_INIT(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
...
L_loop_end_37:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_oneshot"
    .text
    .global sha256_oneshot
    .seh_proc sha256_oneshot
sha256_oneshot:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_feed_packed"
    .text
    .global sha256_feed_packed
    .seh_proc sha256_feed_packed
sha256_feed_packed:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_43:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_oneshot_packed"
    .text
    .global sha256_oneshot_packed
    .seh_proc sha256_oneshot_packed
sha256_oneshot_packed:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_emit_bp"
    .text
    .global sha256_emit_bp
    .seh_proc sha256_emit_bp
sha256_emit_bp:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_45:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_oneshot_packed_bp"
    .text
    .global sha256_oneshot_packed_bp
    .seh_proc sha256_oneshot_packed_bp
sha256_oneshot_packed_bp:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_update_byte"
    .text
    .global sha256_update_byte
    .seh_proc sha256_update_byte
sha256_update_byte:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_49:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_finalize_internal"
    .text
    .global sha256_finalize_internal
    .seh_proc sha256_finalize_internal
...
L_loop_end_59:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sha256_digest_byte"
    .text
    .global sha256_digest_byte
    .seh_proc sha256_digest_byte
sha256_digest_byte:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
