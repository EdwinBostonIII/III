...
L_FED_SEAL_E_BADTIER:
    .quad 0xfffffffffffffffe
L_FED_SEAL_E_FULL:
    .quad 0xfffffffffffffffd
L_FED_SEAL_E_ALREADY:
...
L_FED_SEAL_SLOTS:
    .quad 0x100
    .section .bss
    .global L_FED_SEAL_LIVE
L_FED_SEAL_LIVE:
    .zero 2048
    .global L_FED_SEAL_CHILD_TIER
L_FED_SEAL_CHILD_TIER:
    .zero 2048
    .global L_FED_SEAL_PARENT_TIER
L_FED_SEAL_PARENT_TIER:
    .zero 2048
    .global L_FED_SEAL_CHILD_ROOT
L_FED_SEAL_CHILD_ROOT:
    .zero 65536
    .global L_FED_SEAL_PARENT_ROOT
L_FED_SEAL_PARENT_ROOT:
    .zero 65536
    .section .data
    .global L_FED_SEAL_USED
L_FED_SEAL_USED:
    .quad 0x0
    .global L_FED_SEAL_DOM
L_FED_SEAL_DOM:
    .byte 0x46
    .byte 0x45
    .byte 0x44
...
L_if_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_anchor_count"
    .text
    .global fed_seal_anchor_count
    .seh_proc fed_seal_anchor_count
fed_seal_anchor_count:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_anchor_with_qc"
    .text
    .global fed_seal_anchor_with_qc
    .seh_proc fed_seal_anchor_with_qc
fed_seal_anchor_with_qc:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_19:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_lookup_anchor"
    .text
    .global fed_seal_lookup_anchor
    .seh_proc fed_seal_lookup_anchor
fed_seal_lookup_anchor:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_23:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_anchor"
    .text
    .global fed_seal_anchor
    .seh_proc fed_seal_anchor
fed_seal_anchor:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_43:
    ...
    popq %rax
    movl %edx, (%rax,%rcx,4)
    leaq L_FED_SEAL_PARENT_TIER(%rip), %rax
    pushq %rax
    movl -72(%rbp), %eax
    pushq %rax
    movl -56(%rbp), %eax
...
L_loop_end_45:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_anchor_byte"
    .text
    .global fed_seal_anchor_byte
    .seh_proc fed_seal_anchor_byte
fed_seal_anchor_byte:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_53:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_compute_chain_root"
    .text
    .global fed_seal_compute_chain_root
    .seh_proc fed_seal_compute_chain_root
fed_seal_compute_chain_root:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_73:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "fed_seal_clear"
    .text
    .global fed_seal_clear
    .seh_proc fed_seal_clear
fed_seal_clear:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
