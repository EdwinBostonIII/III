...
L_if_end_9:
    ...
    popq %rax
L_if_end_11:
    movabsq $0xcafebabefeedface, %rax
    pushq %rax
    popq %rcx
    subq $32, %rsp
    callq bitops_popcount64
...
L_if_end_45:
    ...
    addq $32, %rsp
    pushq %rax
    movabsq $0x23456789abcdef01, %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
