...
L_TPL:
    .zero 1344
    .section .data
    .global L_TEST_DISPATCHED
L_TEST_DISPATCHED:
    .quad 0x0
    .section .iii.ring3,"n"
    .asciz "kat_dispatch"
    .text
    .seh_proc L_kat_dispatch
L_kat_dispatch:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    movq %r8, -24(%rbp)
    movq %r9, -32(%rbp)
    movq L_TEST_DISPATCHED(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
    ...
    pushq %rax
    popq %rax
    movq %rax, L_TEST_DISPATCHED(%rip)
    movabsq $0x4b4b, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
...
L_loop_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "dynamic_intent"
    .text
    .seh_proc L_dynamic_intent
L_dynamic_intent:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_11:
    ...
    popq %rax
    subq $32, %rsp
    callq pattern_registry_unseal_for_test
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
