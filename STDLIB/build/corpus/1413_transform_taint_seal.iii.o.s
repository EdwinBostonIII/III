...
L_if_end_9:
    subq $32, %rsp
    callq transform_pattern_set_get
    addq $32, %rsp
    pushq %rax
    movq -32(%rbp), %rax
    pushq %rax
...
L_if_end_11:
    subq $32, %rsp
    callq call_context_table_reset
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
...
L_if_end_35:
    subq $32, %rsp
    callq tempaloc_type_deadline
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -72(%rbp)
    subq $32, %rsp
    callq tempaloc_type_seal
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -80(%rbp)
