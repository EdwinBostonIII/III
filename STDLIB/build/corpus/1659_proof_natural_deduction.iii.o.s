...
L_build_assume:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "build_axiom_impl"
    .text
    .seh_proc L_build_axiom_impl
L_build_axiom_impl:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
