...
main:
    ...
    .seh_endprologue
    subq $32, %rsp
    callq catalyst_clear_all
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    subq $32, %rsp
    callq promote_clear_all
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
...
L_if_end_9:
    subq $32, %rsp
    callq promote_vocabulary_count
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0x1, %rax
...
L_if_end_11:
    subq $32, %rsp
    callq promote_vocabulary_active_count
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0x1, %rax
