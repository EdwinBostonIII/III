...
L_if_end_55:
    ...
    popq %rcx
    subq $32, %rsp
    callq glyph_crystal_unpack_parent
    addq $32, %rsp
    pushq %rax
    movabsq $0xc0, %rax
    pushq %rax
...
L_if_end_57:
    ...
    popq %rcx
    subq $32, %rsp
    callq glyph_crystal_unpack_error_code
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0xe100, %rax
...
L_if_end_59:
    ...
    popq %rcx
    subq $32, %rsp
    callq glyph_crystal_unpack_edge_count
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0x5, %rax
