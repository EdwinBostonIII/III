...
L_if_end_51:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_create_channel
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_if_end_55:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_verify_signature
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_if_end_57:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_decrypt_buffer_with_key
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_if_end_59:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_destroy_socket
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
