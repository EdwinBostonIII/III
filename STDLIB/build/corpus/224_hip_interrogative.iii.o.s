...
L_loop_end_9:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_is_buffer_valid
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_if_end_15:
    ...
    movl %eax, %eax
    pushq %rax
    movl L_C224_INTERROGATIVE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_21:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__phrase_are_sockets_sealed
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_if_end_29:
    ...
    movl %eax, %eax
    pushq %rax
    movl L_C224_IMPERATIVE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
