...
L_loop_top_18:
    ...
    popq %rcx
    subq $32, %rsp
    callq calculus_root_mhash_byte
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0xff, %rax
...
L_if_end_27:
    subq $32, %rsp
    callq L__check_primitive_metadata
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
