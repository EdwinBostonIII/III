...
L__bench_scalar:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_BENCH_LAST_PACKED(%rip)
    movq -48(%rbp), %rax
    pushq %rax
    movq -32(%rbp), %rax
    pushq %rax
...
L__bench_avx2:
    ...
    popq %r8
    subq $32, %rsp
    callq iii_resolver_unit_resolve_avx2
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
...
L__bench_avx512:
    ...
    popq %r8
    subq $32, %rsp
    callq iii_resolver_unit_resolve_avx512
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
...
L_if_end_5:
    ...
    popq %r8
    subq $32, %rsp
    callq L__bench_scalar
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
    movq L_BENCH_LAST_PACKED(%rip), %rax
    pushq %rax
    popq %rax
    movq %rax, -64(%rbp)
    movq -64(%rbp), %rax
