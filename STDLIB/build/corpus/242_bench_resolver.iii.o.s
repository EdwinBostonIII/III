...
L_if_end_15:
    ...
    popq %rax
    movq %rax, -48(%rbp)
    # III_PE_RECORD slot=5 -> sha256_oneshot
    movq -48(%rbp), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
...
L_loop_top_18:
    ...
    popq %rax
    movq %rax, -72(%rbp)
    # III_PE_RECORD slot=8 -> sha256_oneshot
    subq $32, %rsp
    callq bench_now_p
    addq $32, %rsp
    pushq %rax
...
L_if_end_37:
    ...
    popq %rax
    subq $32, %rsp
    callq resolver_fast_path_hits_reset
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
