...
L_str_17:
    ...
    .section .bss
    .global L_BENCH_HIP_DELTAS
L_BENCH_HIP_DELTAS:
    .zero 6400
    .section .rodata
L_C244_BUDGET_UNIQUE:
    .quad 0x7530
L_C244_BUDGET_AMBIGUOUS:
    .quad 0x88b8
L_C244_BUDGET_NO_MATCH:
    .quad 0x3a98
L_C244_BUDGET_IDOC:
    .quad 0x2ee0
L_C244_SAMPLES:
    .quad 0x64
    .section .bss
    .global L_C244_CANDS_PTR
L_C244_CANDS_PTR:
    .zero 64
    .global L_C244_META_PTR
L_C244_META_PTR:
    .zero 64
    .global L_C244_IDOC_ENV_PTR
L_C244_IDOC_ENV_PTR:
    .zero 64
    .global L_C244_IDOC_FIDS_PTR
L_C244_IDOC_FIDS_PTR:
    .zero 64
    .global L_C244_IDOC_FDPA_PTR
L_C244_IDOC_FDPA_PTR:
    .zero 64
    .global L_C244_IDOC_FLNA_PTR
L_C244_IDOC_FLNA_PTR:
    .zero 64
    .global L_C244_IDOC_OFD_PTR
L_C244_IDOC_OFD_PTR:
    .zero 64
    .global L_C244_IDOC_OFL_PTR
L_C244_IDOC_OFL_PTR:
    .zero 64
    .global L_C244_IDOC_DIG_PTR
L_C244_IDOC_DIG_PTR:
    .zero 64
    .section .iii.ring3,"n"
    .asciz "_read_u64"
...
L__sort_deltas:
    ...
    popq %rax
    movq %rax, -16(%rbp)
    leaq L_BENCH_HIP_DELTAS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L__idoc_set_env:
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_ENV_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_DIG_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L__idoc_set_facets:
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_FIDS_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_FDPA_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_FLNA_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L__idoc_set_outs:
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_OFD_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
    ...
    movabsq $0x0, %rax
    pushq %rax
    leaq L_C244_IDOC_OFL_PTR(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L_if_end_29:
    ...
    movq -56(%rbp), %rax
    pushq %rax
    movq L_C244_BUDGET_UNIQUE(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_33:
    ...
    movq -80(%rbp), %rax
    pushq %rax
    movq L_C244_BUDGET_AMBIGUOUS(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_37:
    ...
    movq -104(%rbp), %rax
    pushq %rax
    movq L_C244_BUDGET_NO_MATCH(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_75:
    ...
    movq -296(%rbp), %rax
    pushq %rax
    movq L_C244_BUDGET_IDOC(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
