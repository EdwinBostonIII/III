...
# Microsoft x64 ABI; gas syntax (AT&T); PE/COFF target
    ...
    .section .rodata
L_str_0:
    .ascii "resolution_init.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iiiself_reformatter.iii\0"
L_str_1:
...
main:
    ...
    popq %rax
    subq $32, %rsp
    callq self_reformatter_reset
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    subq $32, %rsp
    callq self_reformatter_call_count
    addq $32, %rsp
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
...
L_if_end_3:
    subq $32, %rsp
    callq self_reformatter_trigger_interval
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -8(%rbp)
...
L_if_end_19:
    subq $32, %rsp
    callq self_reformatter_total_proposed
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
    subq $32, %rsp
    callq self_reformatter_total_rejected
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -48(%rbp)
    subq $32, %rsp
    callq self_reformatter_total_promoted
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
