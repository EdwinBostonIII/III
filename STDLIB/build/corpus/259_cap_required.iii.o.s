...
L_str_4:
    .ascii "kchain.iii\0"
    .section .rodata
L_C259_RIGHT_CRYPTO_SIGN:
    .quad 0x1000
L_C259_RIGHT_NET_DIAL:
    .quad 0x20
L_C259_FAIL_SENTINEL:
...
L_if_end_1:
    movabsq $0x0, %rax
    pushq %rax
    movq L_C259_RIGHT_CRYPTO_SIGN(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_3:
    movabsq $0x0, %rax
    pushq %rax
    movq L_C259_RIGHT_NET_DIAL(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_19:
    ...
    movq -88(%rbp), %rax
    pushq %rax
    movq L_C259_FAIL_SENTINEL(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
