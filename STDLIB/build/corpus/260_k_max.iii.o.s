...
L_if_end_1:
    movabsq $0x0, %rax
    pushq %rax
    movq L_C260_RIGHT_CRYPTO(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_11:
    ...
    movq -64(%rbp), %rax
    pushq %rax
    movq L_C260_FAIL_SENTINEL(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
