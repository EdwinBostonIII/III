...
L__combined_op:
    ...
    addq $32, %rsp
    testb %al, %al
    jnz L_cap_ok_805306397
    movq $0xFFFFFFFFFFFFFFFF, %rax
    movq %rbp, %rsp
    popq %rbp
    retq
L_cap_ok_805306397:
    # III_HEXAD_KIND_CHECK (Phase 3 Step 3)
    movq -8(%rbp), %rcx
    subq $32, %rsp
    callq call_context_hexad_kind
    addq $32, %rsp
    movzbq %al, %rax
    movabsq $0x6, %rcx
    cmpq %rcx, %rax
    je L_hexad_ok_805306397
    movq $0xFFFFFFFFFFFFFFFF, %rax
    movq %rbp, %rsp
    popq %rbp
    retq
L_hexad_ok_805306397:
...
L_cap_ok_805306409:
    ...
    movabsq $0x6, %rcx
    cmpq %rcx, %rax
    je L_hexad_ok_805306409
    movq $0xFFFFFFFFFFFFFFFF, %rax
    movq %rbp, %rsp
    popq %rbp
    retq
L_hexad_ok_805306409:
    # III_K_MAX_CHECK (Phase 3 Step 3)
    movq -8(%rbp), %rcx
    subq $32, %rsp
    callq call_context_kchain_id
