...
L_build_dynamic_intent:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "use_cross_fn_pe_dynamic"
    .text
    .global L_use_cross_fn_pe_dynamic
    .seh_proc L_use_cross_fn_pe_dynamic
L_use_cross_fn_pe_dynamic:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
main:
    ...
    .seh_endprologue
    subq $32, %rsp
    callq L_use_cross_fn_pe_dynamic
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -8(%rbp)
