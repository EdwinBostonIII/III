...
L_build_dynamic_intent:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "use_cross_fn_pe_neg"
    .text
    .global L_use_cross_fn_pe_neg
    .seh_proc L_use_cross_fn_pe_neg
L_use_cross_fn_pe_neg:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
