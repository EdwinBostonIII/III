...
L_if_end_31:
    ...
    popq %rax
L_if_end_33:
    movabsq $0x80000000ffffffff, %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
    ...
    pushq %rax
    movabsq $0xfffffffe00000000, %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
