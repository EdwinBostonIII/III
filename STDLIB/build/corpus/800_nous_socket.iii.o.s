...
L_c800_mkval:
    ...
    movl %eax, %eax
    pushq %rax
    movzbq L_C800_TRIT_VAL(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    subq $32, %rsp
...
L_loop_top_4:
    ...
    movslq -16(%rbp), %rax
    pushq %rax
    movzbq L_C800_TRIT_AND(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_13:
    ...
    movslq -16(%rbp), %rax
    pushq %rax
    movzbq L_C800_TRIT_SUM(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
