...
main:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    leaq L_rd_dispatch_a(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movabsq $0xa5a50005, %rax
    pushq %rax
    movabsq $0x5, %rax
    pushq %rax
    popq %rcx
    ...
    popq %rax
L_if_end_5:
    leaq L_rd_dispatch_b(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movabsq $0xa5a50006, %rax
    pushq %rax
    movabsq $0x6, %rax
    pushq %rax
    popq %rcx
...
L_if_end_9:
    ...
    popq %r9
    subq $32, %rsp
    callq proof_ripple_corpus_equiv_verify
    addq $32, %rsp
    addq $8, %rsp
    addq $8, %rsp
    movzbq %al, %rax
