...
L_if_end_9:
    ...
    popq %rdx
    subq $32, %rsp
    callq endian_load_u32_be
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0x78563412, %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_17:
    ...
    popq %rcx
    subq $32, %rsp
    callq endian_bswap64
    addq $32, %rsp
    pushq %rax
    movabsq $0xefcdab8967452301, %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
