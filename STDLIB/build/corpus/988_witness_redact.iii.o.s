...
L_if_end_15:
    ...
    jmp L_loop_top_12
L_loop_end_13:
    leaq L_PAY_LEN(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movabsq $0x10, %rax
    pushq %rax
    leaq L_PAY_OUT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movq -16(%rbp), %rax
