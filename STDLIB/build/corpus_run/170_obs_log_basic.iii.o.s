...
L_if_end_17:
    ...
    popq %rdx
    subq $32, %rsp
    callq obs_log_at_msg_hash_byte
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    movabsq $0x55, %rax
