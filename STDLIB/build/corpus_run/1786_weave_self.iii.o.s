...
L_CENSUS:
    .zero 48
    .section .iii.ring3,"n"
    .asciz "build_self_model"
    .text
    .seh_proc L_build_self_model
L_build_self_model:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
