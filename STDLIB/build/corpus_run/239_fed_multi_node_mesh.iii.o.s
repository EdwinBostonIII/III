...
L_loop_top_14:
    ...
    jmp L_loop_top_14
L_loop_end_15:
    leaq L_NODE_A_SK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -24(%rbp)
    leaq L_NODE_B_SK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -32(%rbp)
    leaq L_NODE_C_SK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    leaq L_NODE_A_PK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -48(%rbp)
    leaq L_NODE_B_PK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
    leaq L_NODE_C_PK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
