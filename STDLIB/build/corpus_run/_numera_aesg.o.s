...
L_aes_init_tables:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_AES_TABLES_INIT(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_loop_end_11:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "aes128_set_key"
    .text
    .global aes128_set_key
    .seh_proc aes128_set_key
aes128_set_key:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    popq %r8
    subq $32, %rsp
    callq L_aes_expand_key_into
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    movl L_AES128_ROUNDS(%rip), %eax
    pushq %rax
    popq %rax
    movl %eax, L_AES_NR(%rip)
    movabsq $0x1, %rax
    pushq %rax
    popq %rax
    movb %al, L_AES_KEY_SET(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "aes256_set_key"
    .text
    .global aes256_set_key
    .seh_proc aes256_set_key
aes256_set_key:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "aes192_set_key"
    .text
    .global aes192_set_key
    .seh_proc aes192_set_key
aes192_set_key:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_aes_inv_mix_columns:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_aes_inv_mix_one_column
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "aes_encrypt_block"
    .text
    .global aes_encrypt_block
    .seh_proc aes_encrypt_block
aes_encrypt_block:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_top_28:
    ...
    popq %rax
    subq $32, %rsp
    callq L_aes_shift_rows
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    subq $32, %rsp
    callq L_aes_mix_columns
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
...
L_loop_end_31:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "aes_decrypt_block"
    .text
    .global aes_decrypt_block
    .seh_proc aes_decrypt_block
aes_decrypt_block:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
