...
L_BGOV_CAP_RIGHT_BRANCH_OPS:
    .quad 0x4000
L_BGOV_CONS_SENT:
    .quad 0xffffffff
L_BGOV_CLAUSE_RETIRE_LEN:
    .quad 0x10
L_BGOV_CLAUSE_MERGE_LEN:
    .quad 0xf
L_BGOV_W_PAYLOAD_LEN:
    .quad 0x30
    .section .data
    .global L_BGOV_INITED
L_BGOV_INITED:
    .quad 0x0
    .section .bss
    .global L_BGOV_CLAUSE_LABEL
L_BGOV_CLAUSE_LABEL:
    .zero 128
    .global L_BGOV_CLAUSE_ID
L_BGOV_CLAUSE_ID:
    .zero 256
    .global L_BGOV_W_PRODUCER
L_BGOV_W_PRODUCER:
    .zero 256
    .global L_BGOV_W_OP
L_BGOV_W_OP:
    .zero 256
    .global L_BGOV_W_INCOMMIT
L_BGOV_W_INCOMMIT:
    .zero 256
    .global L_BGOV_W_OUTCOMMIT
L_BGOV_W_OUTCOMMIT:
    .zero 256
    .global L_BGOV_W_PAYLOAD
L_BGOV_W_PAYLOAD:
    .zero 384
    .global L_BGOV_W_FID
L_BGOV_W_FID:
...
L__bgov_fill_label:
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    leaq L_BGOV_CLAUSE_LABEL(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L__bgov_check_clause:
    ...
    testq %rax, %rax
    jz L_if_end_5
    movslq L_BGOV_E_CLAUSE_ABSENT(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L__bgov_emit_governance:
    ...
    movq %rcx, -8(%rbp)
    movq %rdx, -16(%rbp)
    leaq L_BGOV_W_PRODUCER(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movq %rax, -32(%rbp)
    leaq L_BGOV_W_INCOMMIT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movq %rax, -40(%rbp)
    leaq L_BGOV_W_OUTCOMMIT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_loop_end_7:
    ...
    testq %rax, %rax
    jz L_if_end_9
    movslq L_BGOV_E_WITNESS(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_11:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "bg_retire_branch"
    .text
    .global bg_retire_branch
    .seh_proc bg_retire_branch
bg_retire_branch:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    testq %rax, %rax
    jz L_if_end_13
    movslq L_BGOV_E_NOT_INITED(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_13:
    ...
    popq %rax
L_if_end_15:
    movq L_BGOV_CAP_RIGHT_BRANCH_OPS(%rip), %rax
    pushq %rax
    movq -16(%rbp), %rax
    pushq %rax
    popq %rcx
    ...
    testq %rax, %rax
    jz L_if_end_17
    movslq L_BGOV_E_CAP_DENIED(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_17:
    ...
    popq %rcx
    subq $32, %rsp
    callq L__bgov_fill_label
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    movq L_BGOV_CLAUSE_RETIRE_LEN(%rip), %rax
    pushq %rax
    popq %rcx
    subq $32, %rsp
    callq L__bgov_check_clause
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
...
L_if_end_21:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "bg_merge_branch"
    .text
    .global bg_merge_branch
    .seh_proc bg_merge_branch
bg_merge_branch:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_33:
    ...
    pushq %rax
    popq %rax
    movq L_BGOV_CLAUSE_MERGE_LEN(%rip), %rax
    pushq %rax
    popq %rcx
    subq $32, %rsp
    callq L__bgov_check_clause
...
L_if_end_37:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "bg_commit_merge"
    .text
    .global bg_commit_merge
    .seh_proc bg_commit_merge
bg_commit_merge:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
