...
L_NET_IPPROTO_TCP:
    .quad 0x6
L_NET_INVALID_SOCKET:
    .quad 0xffffffffffffffff
    .section .bss
    .global L_NET_WSADATA
L_NET_WSADATA:
    .zero 3264
    .section .data
    .global L_NET_INITED
...
L_if_end_9:
    ...
    movq -32(%rbp), %rax
    pushq %rax
    movq L_NET_INVALID_SOCKET(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_15:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "net_tcp_listen_ipv4"
    .text
    .global net_tcp_listen_ipv4
    .seh_proc net_tcp_listen_ipv4
net_tcp_listen_ipv4:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    movq %rdx, -16(%rbp)
    movq %r8, -24(%rbp)
    movq L_NET_RIGHT_LISTEN(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_27:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "net_tcp_accept"
    .text
    .global net_tcp_accept
    .seh_proc net_tcp_accept
net_tcp_accept:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_35:
    ...
    .text
    .global net_tcp_send
    .seh_proc net_tcp_send
net_tcp_send:
    # III_SOVEREIGN_AUDIT SOVVAL net_tcp_send p1
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_41:
    ...
    .text
    .global net_tcp_recv
    .seh_proc net_tcp_recv
net_tcp_recv:
    # III_SOVEREIGN_AUDIT SOURCE net_tcp_recv p1
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_49:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "net_pack_sockaddr_ipv4"
    .text
    .global net_pack_sockaddr_ipv4
    .seh_proc net_pack_sockaddr_ipv4
net_pack_sockaddr_ipv4:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
