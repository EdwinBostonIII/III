...
L_NODEID_MAX_INPUT:
    .quad 0x1fff
L_NODEID_RIGHT_ATTEST:
    .quad 0x800
L_NODEID_RIGHT_SIGN:
    .quad 0x1000
L_NODEID_INFO_ID_LEN:
    .quad 0x13
L_NODEID_INFO_COMM_LEN:
    .quad 0x18
L_NODEID_INFO_WIT_LEN:
    .quad 0x12
L_NODEID_PRODUCER_LEN:
    .quad 0x15
L_NODEID_OPID_LEN:
    .quad 0x1c
    .section .bss
    .global L_NODEID_ID_KEYS
L_NODEID_ID_KEYS:
    .zero 512
    .global L_NODEID_COMM_KEYS
L_NODEID_COMM_KEYS:
    .zero 512
    .global L_NODEID_WIT_KEYS
L_NODEID_WIT_KEYS:
    .zero 512
    .global L_NODEID_NODE_ID
L_NODEID_NODE_ID:
    .zero 256
    .global L_NODEID_NODE_SEED
L_NODEID_NODE_SEED:
    .zero 256
    .global L_NODEID_HKDF_SEED
L_NODEID_HKDF_SEED:
    .zero 256
    .global L_NODEID_PRIV_SCRAP
L_NODEID_PRIV_SCRAP:
    .zero 512
    .global L_NODEID_CONCAT
L_NODEID_CONCAT:
    .zero 65792
    .global L_NODEID_PRODUCER
L_NODEID_PRODUCER:
    .zero 256
    .global L_NODEID_OPID_BIRTH
L_NODEID_OPID_BIRTH:
    .zero 256
    .global L_NODEID_INFO_ID
L_NODEID_INFO_ID:
    .zero 192
    .global L_NODEID_INFO_COMM
L_NODEID_INFO_COMM:
    .zero 192
    .global L_NODEID_INFO_WIT
L_NODEID_INFO_WIT:
    .zero 192
    .global L_NODEID_PROD_STR
L_NODEID_PROD_STR:
    .zero 256
    .global L_NODEID_OPID_STR
L_NODEID_OPID_STR:
    .zero 256
    .global L_NODEID_IN_COMMIT
L_NODEID_IN_COMMIT:
    .zero 256
    .section .data
    .global L_NODEID_INITED
L_NODEID_INITED:
    .quad 0x0
    .global L_NODEID_INFO_READY
L_NODEID_INFO_READY:
    .quad 0x0
    .section .bss
    .global L_NODEID_ST_ARGS
L_NODEID_ST_ARGS:
    .zero 256
    .global L_NODEID_ST_HW
L_NODEID_ST_HW:
    .zero 64
    .global L_NODEID_ST_BS
L_NODEID_ST_BS:
    .zero 64
    .global L_NODEID_ST_SEEDREF
L_NODEID_ST_SEEDREF:
    .zero 256
    .global L_NODEID_ST_PUB
L_NODEID_ST_PUB:
    .zero 256
    .global L_NODEID_ST_PUB2
L_NODEID_ST_PUB2:
    .zero 256
    .global L_NODEID_ST_PUB3
L_NODEID_ST_PUB3:
    .zero 256
    .global L_NODEID_ST_IDREF
L_NODEID_ST_IDREF:
    .zero 256
    .global L_NODEID_ST_IDOUT
L_NODEID_ST_IDOUT:
    .zero 256
    .global L_NODEID_ST_MSG
L_NODEID_ST_MSG:
    .zero 32
    .global L_NODEID_ST_SIG
L_NODEID_ST_SIG:
    .zero 512
    .global L_NODEID_ST_SIG2
L_NODEID_ST_SIG2:
    .zero 512
    .global L_NODEID_ST_CONCAT
L_NODEID_ST_CONCAT:
    .zero 128
    .section .iii.ring3,"n"
    .asciz "ni_build_info"
...
L_ni_build_info:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_NODEID_INFO_READY(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_if_end_1:
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_NODEID_PROD_STR(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    movabsq $0x61, %rax
...
L_loop_top_2:
    movq -8(%rbp), %rax
    pushq %rax
    movq L_NODEID_PRODUCER_LEN(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
    ...
    testq %rax, %rax
    jz L_loop_end_3
    leaq L_NODEID_OPID_STR(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    leaq L_NODEID_PROD_STR(%rip), %rax
...
L_loop_end_3:
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_NODEID_PRODUCER(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    leaq L_NODEID_OPID_BIRTH(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    pushq %rax
    movq L_NODEID_OPID_LEN(%rip), %rax
    pushq %rax
    leaq L_NODEID_OPID_STR(%rip), %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    movb %al, L_NODEID_INFO_READY(%rip)
    movslq L_NODEID_OK(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
...
L_ni_derive_role:
    ...
    movq %rdx, -16(%rbp)
    movq %r8, -24(%rbp)
    leaq L_NODEID_HKDF_SEED(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_loop_end_9:
    ...
    popq %rax
    movq %rax, -48(%rbp)
    leaq L_NODEID_PRIV_SCRAP(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %r8
    subq $32, %rsp
    callq ed25519_keypair_from_seed
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
...
L_ni_witness_birth:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    leaq L_NODEID_IN_COMMIT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_27:
    ...
    popq %rax
    pushq %rax
    leaq L_NODEID_COMM_KEYS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L_if_end_29:
    ...
    popq %rax
    pushq %rax
    leaq L_NODEID_WIT_KEYS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L_if_end_35:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_init_witnessed"
    .text
    .global ni_init_witnessed
    .seh_proc ni_init_witnessed
ni_init_witnessed:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_ni_copy_pub:
    ...
    movq %rcx, -8(%rbp)
    movq %rdx, -16(%rbp)
    movzbq L_NODEID_INITED(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
...
L_loop_end_43:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_identity_pub"
    .text
    .global ni_identity_pub
    .seh_proc ni_identity_pub
ni_identity_pub:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_communication_pub"
    .text
    .global ni_communication_pub
    .seh_proc ni_communication_pub
ni_communication_pub:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_witness_pub"
    .text
    .global ni_witness_pub
    .seh_proc ni_witness_pub
ni_witness_pub:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_49:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_identity_sign"
    .text
    .global ni_identity_sign
    .seh_proc ni_identity_sign
ni_identity_sign:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_communication_sign"
    .text
    .global ni_communication_sign
    .seh_proc ni_communication_sign
ni_communication_sign:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "ni_witness_sign"
    .text
    .global ni_witness_sign
    .seh_proc ni_witness_sign
ni_witness_sign:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_77:
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_NODEID_ST_SEEDREF(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movabsq $0x6, %rax
