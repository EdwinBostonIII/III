...
L_RSTORE_ADDR_BYTES:
    .quad 0x20
    .section .bss
    .global L_RSTORE_PATH
L_RSTORE_PATH:
    .zero 192
    .global L_RSTORE_ADDR
L_RSTORE_ADDR:
    .zero 256
    .global L_RSTORE_LEN8
L_RSTORE_LEN8:
    .zero 64
    .section .data
    .global L_RSTORE_FOUND_LEN
L_RSTORE_FOUND_LEN:
    .quad 0x0
    .section .iii.ring3,"n"
...
L__rstore_locate:
    ...
    popq %rax
    movq %rax, -40(%rbp)
    movl L_RSTORE_MODE_READ(%rip), %eax
    pushq %rax
    movq -40(%rbp), %rax
    pushq %rax
    movq -32(%rbp), %rax
...
L_if_end_13:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_RSTORE_FOUND_LEN(%rip)
    movq -48(%rbp), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    popq %rax
L_if_end_17:
    movl L_RSTORE_SEEK_CUR(%rip), %eax
    pushq %rax
    movq -80(%rbp), %rax
    pushq %rax
    movq -48(%rbp), %rax
...
L_loop_end_7:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "reach_store_has"
    .text
    .global reach_store_has
    .seh_proc reach_store_has
reach_store_has:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_19:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "reach_store_get"
    .text
    .global reach_store_get
    .seh_proc reach_store_get
reach_store_get:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_21:
    ...
    pushq %rax
    popq %rax
    movslq L_RSTORE_E_TOOBIG(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_25:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "reach_store_put"
    .text
    .global reach_store_put
    .seh_proc reach_store_put
reach_store_put:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_27:
    ...
    popq %rax
    movq %rax, -72(%rbp)
    movl L_RSTORE_MODE_APPEND(%rip), %eax
    pushq %rax
    movq -72(%rbp), %rax
    pushq %rax
    movq -64(%rbp), %rax
