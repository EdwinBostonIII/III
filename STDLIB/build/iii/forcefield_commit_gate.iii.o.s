...
L_if_end_1:
    ...
    testq %rax, %rax
    jz L_if_end_3
    movl L_CG_REJECT_MODULE(%rip), %eax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_5:
    ...
    testq %rax, %rax
    jz L_if_end_7
    movl L_CG_REJECT_STRENGTH(%rip), %eax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
cg_seal_ok:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movl L_CG_SUITE_SHA256(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
