...
L_RL_CAI_MASK:
    .quad 0xfff
    .section .bss
    .global L_RL_CAI_KEYS
L_RL_CAI_KEYS:
    .zero 1048576
    .global L_RL_CAI_VALS
L_RL_CAI_VALS:
    .zero 32768
    .global L_RL_KEY
L_RL_KEY:
...
rl_run:
    ...
    popq %rax
L_if_end_1:
    leaq L_RL_CAI_KEYS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -32(%rbp)
    leaq L_RL_CAI_VALS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
    leaq L_RL_KEY(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
