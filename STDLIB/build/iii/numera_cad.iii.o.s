...
L_loop_end_53:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cad_branch_key"
    .text
    .global cad_branch_key
    .seh_proc cad_branch_key
cad_branch_key:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
