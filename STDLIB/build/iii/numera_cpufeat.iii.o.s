...
L_cf_cpuid_word:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_vendor_ebx"
    .text
    .global cpufeat_vendor_ebx
    .seh_proc cpufeat_vendor_ebx
cpufeat_vendor_ebx:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_vendor_edx"
    .text
    .global cpufeat_vendor_edx
    .seh_proc cpufeat_vendor_edx
cpufeat_vendor_edx:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_vendor_ecx"
    .text
    .global cpufeat_vendor_ecx
    .seh_proc cpufeat_vendor_ecx
cpufeat_vendor_ecx:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
cpufeat_fms:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_logical_count"
    .text
    .global cpufeat_logical_count
    .seh_proc cpufeat_logical_count
cpufeat_logical_count:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_hypervisor_present"
    .text
    .global cpufeat_hypervisor_present
    .seh_proc cpufeat_hypervisor_present
cpufeat_hypervisor_present:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_39:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "cpufeat_hv_ebx"
    .text
    .global cpufeat_hv_ebx
    .seh_proc cpufeat_hv_ebx
cpufeat_hv_ebx:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
