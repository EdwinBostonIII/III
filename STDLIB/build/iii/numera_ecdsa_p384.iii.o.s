...
L_if_end_3:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "iii_ecdsa_p384_sig_range_ok"
    .text
    .global iii_ecdsa_p384_sig_range_ok
    .seh_proc iii_ecdsa_p384_sig_range_ok
iii_ecdsa_p384_sig_range_ok:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_iii_ecdsa_p384_verify:
    ...
    popq %rcx
    subq $32, %rsp
    callq iii_ecdsa_p384_sig_range_ok
    addq $32, %rsp
    movzbq %al, %rax
    pushq %rax
    movabsq $0x0, %rax
