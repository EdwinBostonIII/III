...
L_H12_U32MASK:
    .quad 0xffffffff
    .section .bss
    .global L_H12_CLAUSE_KIND
L_H12_CLAUSE_KIND:
    .zero 512
    .section .data
    .global L_H12_CLAUSE_COUNT
L_H12_CLAUSE_COUNT:
    .quad 0x0
    .section .bss
    .global L_H12_MSGA
...
h12_init:
    ...
    pushq %rax
    popq %rax
    movl %eax, L_H12_CLAUSE_COUNT(%rip)
    leaq L_H12_MSGA(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    movabsq $0x61, %rax
...
L_h12_hash_reproduces:
    ...
    movq -16(%rbp), %rax
    pushq %rax
    movl L_H12_SUITE_SHA256(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_1:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_H12_A3(%rip)
    movq L_H12_A1(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
...
L_h12_clause_eval:
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    leaq L_H12_CLAUSE_KIND(%rip), %rax
    pushq %rax
    movl -8(%rbp), %eax
    pushq %rax
    popq %rax
    pushq %rax
    movq L_H12_U32MASK(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    andq %rcx, %rax
    ...
    movzbq -16(%rbp), %rax
    pushq %rax
    movzbq L_H12_KIND_REPRODUCE(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_27:
    movzbq -16(%rbp), %rax
    pushq %rax
    movzbq L_H12_KIND_CANARY(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_h12_register:
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    movl L_H12_CLAUSE_COUNT(%rip), %eax
    pushq %rax
    popq %rax
    movq %rax, -16(%rbp)
    movl -16(%rbp), %eax
    pushq %rax
    movl L_H12_MAX_CLAUSES(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_35:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "h12_run_charter"
    .text
    .global h12_run_charter
    .seh_proc h12_run_charter
h12_run_charter:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_39:
    ...
    jmp L_loop_top_36
L_loop_end_37:
    movq L_H12_VERDICT_GREEN(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
