...
L_H8_BAD_IDX:
    ...
    .section .bss
    .global L_H8_CLAUSE_KIND
L_H8_CLAUSE_KIND:
    .zero 512
    .section .data
    .global L_H8_CLAUSE_COUNT
L_H8_CLAUSE_COUNT:
    .quad 0x0
    .section .bss
    .global L_H8_PROD
...
h8_init:
    ...
    pushq %rax
    popq %rax
    movl %eax, L_H8_CLAUSE_COUNT(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
    subq $32, %rsp
...
L_h8_clause_eval:
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    leaq L_H8_CLAUSE_KIND(%rip), %rax
    pushq %rax
    movl -8(%rbp), %eax
    pushq %rax
    popq %rax
    pushq %rax
    movq L_H8_U32MASK(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    andq %rcx, %rax
    ...
    movzbq -16(%rbp), %rax
    pushq %rax
    movzbq L_H8_KIND_RECORD(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_37:
    movzbq -16(%rbp), %rax
    pushq %rax
    movzbq L_H8_KIND_CANARY(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_h8_register:
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    movl L_H8_CLAUSE_COUNT(%rip), %eax
    pushq %rax
    popq %rax
    movq %rax, -16(%rbp)
    movl -16(%rbp), %eax
    pushq %rax
    movl L_H8_MAX_CLAUSES(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_if_end_45:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "h8_run_charter"
    .text
    .global h8_run_charter
    .seh_proc h8_run_charter
h8_run_charter:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_49:
    ...
    jmp L_loop_top_46
L_loop_end_47:
    movq L_H8_VERDICT_GREEN(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
