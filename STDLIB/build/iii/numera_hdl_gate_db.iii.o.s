...
L_hgd_xor_nand_or:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "hgd_verify_all"
    .text
    .global hgd_verify_all
    .seh_proc hgd_verify_all
hgd_verify_all:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_hgd_false_distrib:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "hdl_gate_db_selftest"
    .text
    .global hdl_gate_db_selftest
    .seh_proc hdl_gate_db_selftest
hdl_gate_db_selftest:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
