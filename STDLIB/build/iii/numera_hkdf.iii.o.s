...
L_HKDF_ARENA:
    .quad 0x0
    .global L_HKDF_PRK_BUF
L_HKDF_PRK_BUF:
    .quad 0x0
    .global L_HKDF_T_BUF
L_HKDF_T_BUF:
    .quad 0x0
    .global L_HKDF_MSG_BUF
L_HKDF_MSG_BUF:
    .quad 0x0
    .global L_HKDF_ZERO_SALT
L_HKDF_ZERO_SALT:
    .quad 0x0
    .section .iii.ring3,"n"
    .asciz "hkdf_alloc"
...
L_if_end_3:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_HKDF_ZERO_SALT(%rip)
    movq L_HKDF_ZERO_SALT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_13:
    ...
    popq %rax
    movq %rax, -48(%rbp)
    movq L_HKDF_MSG_BUF(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
    movq L_HKDF_T_BUF(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
