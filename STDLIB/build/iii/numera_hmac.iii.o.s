...
L_if_end_17:
    ...
    popq %rdx
    subq $32, %rsp
    callq L_hmac_prepare_key_sha256
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "hmac_sha256_tag"
    .text
    .global hmac_sha256_tag
    .seh_proc hmac_sha256_tag
hmac_sha256_tag:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_19:
    ...
    popq %rdx
    subq $32, %rsp
    callq L_hmac_prepare_key_sha512
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "hmac_sha512_tag"
    .text
    .global hmac_sha512_tag
    .seh_proc hmac_sha512_tag
hmac_sha512_tag:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
