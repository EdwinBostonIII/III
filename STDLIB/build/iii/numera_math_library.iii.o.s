...
L_MATHLIB_E_DUPLICATE:
    .quad 0xfffffffffffffffc
L_MATHLIB_E_VERIFY_FAIL:
    .quad 0xfffffffffffffffb
L_MATHLIB_E_DEP_ABSENT:
    .quad 0xfffffffffffffffa
L_MATHLIB_E_CLAUSE_ABSENT:
    .quad 0xfffffffffffffff9
L_MATHLIB_E_NOT_INITED:
    .quad 0xfffffffffffffff8
L_MATHLIB_E_EMIT_FAIL:
...
L_MATHLIB_MAX_DEPS:
    .quad 0x40
L_MATHLIB_DEP_BUF_BYTES:
    .quad 0x800
L_MATHLIB_CONS_SENT:
    .quad 0xffffffff
    .section .data
    .global L_MATHLIB_INITED
L_MATHLIB_INITED:
    .quad 0x0
    .section .bss
    .global L_MATHLIB_CARRIER_IDS
L_MATHLIB_CARRIER_IDS:
    .zero 2097152
    .global L_MATHLIB_LIVE
L_MATHLIB_LIVE:
    .zero 524288
    .global L_MATHLIB_REFINES
L_MATHLIB_REFINES:
    .zero 2097152
    .section .data
    .global L_MATHLIB_COUNT
L_MATHLIB_COUNT:
    .quad 0x0
    .section .bss
    .global L_MATHLIB_S_CLAUSE_ID
L_MATHLIB_S_CLAUSE_ID:
    .zero 256
    .global L_MATHLIB_S_LABEL
L_MATHLIB_S_LABEL:
    .zero 128
    .global L_MATHLIB_S_DEPS
L_MATHLIB_S_DEPS:
    .zero 2048
    .global L_MATHLIB_S_PAYLOAD
L_MATHLIB_S_PAYLOAD:
    .zero 640
    .global L_MATHLIB_S_PRODUCER
L_MATHLIB_S_PRODUCER:
    .zero 256
    .global L_MATHLIB_S_OPID
L_MATHLIB_S_OPID:
    .zero 256
    .global L_MATHLIB_S_IN_C
L_MATHLIB_S_IN_C:
    .zero 256
    .global L_MATHLIB_S_OUT_C
L_MATHLIB_S_OUT_C:
    .zero 256
    .global L_MATHLIB_S_ANTE
L_MATHLIB_S_ANTE:
    .zero 256
    .global L_MATHLIB_KAT_TID
L_MATHLIB_KAT_TID:
    .zero 256
    .global L_MATHLIB_KAT_ARGS
L_MATHLIB_KAT_ARGS:
    .zero 64
    .global L_MATHLIB_KAT_CID
L_MATHLIB_KAT_CID:
    .zero 256
    .global L_MATHLIB_KAT_STMT
L_MATHLIB_KAT_STMT:
    .zero 64
    .global L_MATHLIB_KAT_PAB
L_MATHLIB_KAT_PAB:
    .zero 24
    .global L_MATHLIB_KAT_REQ
L_MATHLIB_KAT_REQ:
    .zero 64
    .global L_MATHLIB_KAT_CREQ
L_MATHLIB_KAT_CREQ:
    .zero 128
    .global L_MATHLIB_KAT_CAP
L_MATHLIB_KAT_CAP:
    .zero 256
    .global L_MATHLIB_KAT_OUT
L_MATHLIB_KAT_OUT:
    .zero 256
    .global L_MATHLIB_ST_ID0
L_MATHLIB_ST_ID0:
    .zero 256
    .global L_MATHLIB_ST_ID1
L_MATHLIB_ST_ID1:
    .zero 256
    .global L_MATHLIB_ST_ID2
L_MATHLIB_ST_ID2:
    .zero 256
    .global L_MATHLIB_ST_FRAG
L_MATHLIB_ST_FRAG:
    .zero 256
    .global L_MATHLIB_ST_RETBUF
L_MATHLIB_ST_RETBUF:
    .zero 256
    .global L_MATHLIB_ST_MSG0
L_MATHLIB_ST_MSG0:
    .zero 64
    .global L_MATHLIB_ST_MSG1
L_MATHLIB_ST_MSG1:
    .zero 64
    .global L_MATHLIB_ST_MSG2
L_MATHLIB_ST_MSG2:
    .zero 64
    .global L_MATHLIB_ST_CAP
L_MATHLIB_ST_CAP:
    .zero 256
    .section .iii.ring3,"n"
    .asciz "lib_init"
...
lib_init:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_MATHLIB_INITED(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_loop_end_3:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_MATHLIB_COUNT(%rip)
    movabsq $0x1, %rax
    pushq %rax
    popq %rax
    movb %al, L_MATHLIB_INITED(%rip)
    movslq L_MATHLIB_OK(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
...
L_loop_top_4:
    ...
    testq %rax, %rax
    jz L_if_end_9
    leaq L_MATHLIB_CARRIER_IDS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movq -16(%rbp), %rax
...
lib_admit:
    ...
    testq %rax, %rax
    jz L_if_end_13
    movslq L_MATHLIB_E_NOT_INITED(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_13:
    ...
    testq %rax, %rax
    jz L_if_end_15
    movslq L_MATHLIB_E_NULL(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_17:
    ...
    popq %rax
L_if_end_19:
    leaq L_MATHLIB_S_LABEL(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movb %dl, (%rax,%rcx,1)
    leaq L_MATHLIB_S_CLAUSE_ID(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    movl -48(%rbp), %eax
    pushq %rax
    movl L_MATHLIB_CONS_SENT(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
    ...
    testq %rax, %rax
    jz L_if_end_21
    movslq L_MATHLIB_E_CLAUSE_ABSENT(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_21:
    ...
    testq %rax, %rax
    jz L_if_end_23
    movslq L_MATHLIB_E_VERIFY_FAIL(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_23:
    ...
    testq %rax, %rax
    jz L_if_end_25
    movslq L_MATHLIB_E_DUPLICATE(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_loop_end_29:
    ...
    testq %rax, %rax
    jz L_if_end_35
    movslq L_MATHLIB_E_DEP_ABSENT(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_loop_end_37:
    ...
    testq %rax, %rax
    jz L_if_end_43
    movslq L_MATHLIB_E_FULL(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_43:
    ...
    popq %rax
    movq %rax, -168(%rbp)
    leaq L_MATHLIB_S_PAYLOAD(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_loop_top_44:
    ...
    jmp L_loop_top_44
L_loop_end_45:
    leaq L_MATHLIB_S_PRODUCER(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movq %rax, -200(%rbp)
    leaq L_MATHLIB_S_OUT_C(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_loop_end_47:
    ...
    testq %rax, %rax
    jz L_if_end_49
    movslq L_MATHLIB_E_EMIT_FAIL(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_49:
    ...
    popq %rax
    movq %rax, -248(%rbp)
    leaq L_MATHLIB_REFINES(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movq -168(%rbp), %rax
...
L_if_end_53:
    ...
    testq %rax, %rax
    jz L_if_end_55
    movslq L_MATHLIB_E_ABSENT(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_mathlib_kat_admit:
    ...
    pushq %rax
    popq %rax
    leaq L_MATHLIB_KAT_TID(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
L_if_end_81:
    leaq L_MATHLIB_KAT_ARGS(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_89:
    ...
    popq %rax
L_if_end_91:
    leaq L_MATHLIB_KAT_PAB(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movq %rdx, (%rax,%rcx,8)
    leaq L_MATHLIB_KAT_STMT(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    movabsq $0x41, %rax
    ...
    popq %rax
    pushq %rax
    leaq L_MATHLIB_KAT_REQ(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
L_if_end_93:
    leaq L_MATHLIB_KAT_CID(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_95:
    ...
    popq %rax
L_if_end_97:
    leaq L_MATHLIB_KAT_OUT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    pushq %rax
    leaq L_MATHLIB_KAT_CAP(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
L_if_end_99:
    leaq L_MATHLIB_KAT_CREQ(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_105:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "mathlib_selftest"
    .text
    .global mathlib_selftest
    .seh_proc mathlib_selftest
mathlib_selftest:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_top_106:
    ...
    jmp L_loop_top_106
L_loop_end_107:
    leaq L_MATHLIB_ST_MSG0(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %rax
    movq %rax, -32(%rbp)
    leaq L_MATHLIB_ST_FRAG(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_109:
    ...
    popq %rax
L_if_end_111:
    leaq L_MATHLIB_ST_RETBUF(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_127:
    ...
    popq %rax
L_if_end_129:
    leaq L_MATHLIB_ST_MSG1(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
L_if_end_139:
    ...
    popq %rax
L_if_end_141:
    leaq L_MATHLIB_ST_MSG2(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
