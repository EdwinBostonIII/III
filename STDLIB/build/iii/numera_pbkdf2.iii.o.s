...
L_if_end_3:
    ...
    .text
    .global pbkdf2_sha256_set_salt
    .seh_proc pbkdf2_sha256_set_salt
pbkdf2_sha256_set_salt:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pbkdf2_sha256_set_iter"
    .text
    .global pbkdf2_sha256_set_iter
    .seh_proc pbkdf2_sha256_set_iter
pbkdf2_sha256_set_iter:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pbkdf2_sha256_derive"
    .text
    .global pbkdf2_sha256_derive
    .seh_proc pbkdf2_sha256_derive
