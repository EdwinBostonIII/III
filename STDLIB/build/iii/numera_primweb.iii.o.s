...
pw_toffoli_nontrivial:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_ch_is_mux"
    .text
    .global pw_sha_ch_is_mux
    .seh_proc pw_sha_ch_is_mux
pw_sha_ch_is_mux:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_maj_absorbs"
    .text
    .global pw_sha_maj_absorbs
    .seh_proc pw_sha_maj_absorbs
pw_sha_maj_absorbs:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_maj_nontrivial"
    .text
    .global pw_sha_maj_nontrivial
    .seh_proc pw_sha_maj_nontrivial
pw_sha_maj_nontrivial:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_ch_optform"
    .text
    .global pw_sha_ch_optform
    .seh_proc pw_sha_ch_optform
pw_sha_ch_optform:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_ch_optform_wrong"
    .text
    .global pw_sha_ch_optform_wrong
    .seh_proc pw_sha_ch_optform_wrong
pw_sha_ch_optform_wrong:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_maj_optform"
    .text
    .global pw_sha_maj_optform
    .seh_proc pw_sha_maj_optform
pw_sha_maj_optform:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "pw_sha_maj_optform_wrong"
    .text
    .global pw_sha_maj_optform_wrong
    .seh_proc pw_sha_maj_optform_wrong
pw_sha_maj_optform_wrong:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
