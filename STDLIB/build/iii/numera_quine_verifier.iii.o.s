...
L_QV_MOD_SRC:
    .zero 131072
    .section .data
    .global L_QV_MOD_COUNT
L_QV_MOD_COUNT:
    .quad 0x0
    .section .bss
    .global L_QV_SEED_TARGET
L_QV_SEED_TARGET:
    .zero 256
    .section .data
    .global L_QV_TARGET_SET
L_QV_TARGET_SET:
    .quad 0x0
    .section .bss
    .global L_QV_PRODUCER
L_QV_PRODUCER:
    .zero 256
    .global L_QV_OPID
L_QV_OPID:
...
L_QV_ZERO_ID:
    .zero 256
    .global L_QV_PROD_NAME
L_QV_PROD_NAME:
    .zero 256
    .global L_QV_OPID_NAME
L_QV_OPID_NAME:
    .zero 256
    .global L_QV_T_A
L_QV_T_A:
...
L_loop_end_1:
    ...
    pushq %rax
    popq %rax
    movl %eax, L_QV_MOD_COUNT(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movb %al, L_QV_TARGET_SET(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rax, -8(%rbp)
...
L_loop_end_5:
    ...
    pushq %rax
    popq %rax
    movb %al, L_QV_INITED(%rip)
    movslq L_QV_OK(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "qv_register_module"
    .text
    .global qv_register_module
    .seh_proc qv_register_module
qv_register_module:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_7:
    ...
    popq %rax
L_if_end_9:
    movl L_QV_MOD_COUNT(%rip), %eax
    pushq %rax
    movl L_QV_MAX_MODULES(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_loop_end_13:
    ...
    .asciz "qv_set_target"
    .text
    .global qv_set_target
    .seh_proc qv_set_target
qv_set_target:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_15:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "qv_seed_target"
    .text
    .global qv_seed_target
    .seh_proc qv_seed_target
qv_seed_target:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    popq %rax
L_if_end_17:
    movzbq L_QV_TARGET_SET(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    popq %rcx
    ...
    testq %rax, %rax
    jz L_if_end_19
    movslq L_QV_E_NO_TARGET(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_if_end_33:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "qv_verify_publish"
    .text
    .global qv_verify_publish
    .seh_proc qv_verify_publish
qv_verify_publish:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
