...
L_str_10:
    .ascii "mhash.iii\0"
    .section .rodata
L_SP_OP_U32_ADD_CODE:
    .quad 0x5101
L_SP_OP_U32_SUB_CODE:
    .quad 0x5102
L_SP_OP_U32_MUL_CODE:
    .quad 0x5103
L_SP_OP_U64_ADD_CODE:
    .quad 0x5104
L_SP_OP_U64_SUB_CODE:
    .quad 0x5105
...
L_sp_init_domain:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_SP_DOMAIN_INIT(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_if_end_5:
    ...
    popq %rax
    pushq %rax
    movl L_SP_OP_U32_ADD_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_7:
    ...
    popq %rax
    pushq %rax
    movl L_SP_OP_U32_SUB_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_9:
    ...
    popq %rax
    pushq %rax
    movl L_SP_OP_U32_MUL_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_11:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movl L_SP_OP_U64_ADD_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_13:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movl L_SP_OP_U64_SUB_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_15:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movl L_SP_OP_U64_MUL_CODE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
