...
L_SHA3_512_DOM:
    .quad 0x6
    .section .bss
    .global L_SHA3_512_STATE
L_SHA3_512_STATE:
    .zero 1600
    .section .iii.ring3,"n"
    .asciz "sha3_512_oneshot"
    .text
    .global sha3_512_oneshot
    .seh_proc sha3_512_oneshot
sha3_512_oneshot:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    popq %rax
L_if_end_1:
    leaq L_SHA3_512_STATE(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
    movzbq L_SHA3_512_DOM(%rip), %rax
    pushq %rax
    movl L_SHA3_512_RATE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    subq $32, %rsp
