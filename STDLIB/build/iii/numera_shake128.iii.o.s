...
L_SHAKE128_DOM:
    .quad 0x1f
    .section .bss
    .global L_SHAKE128_STATE
L_SHAKE128_STATE:
    .zero 1600
    .section .iii.ring3,"n"
    .asciz "shake128_oneshot"
    .text
    .global shake128_oneshot
    .seh_proc shake128_oneshot
shake128_oneshot:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    popq %rax
L_if_end_1:
    leaq L_SHAKE128_STATE(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    movq %rax, -72(%rbp)
    movzbq L_SHAKE128_DOM(%rip), %rax
    pushq %rax
    movl L_SHAKE128_RATE(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rdx
    subq $32, %rsp
