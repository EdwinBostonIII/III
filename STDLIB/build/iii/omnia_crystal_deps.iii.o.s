...
L_SID_VIS_MAX_BYTES:
    .quad 0x2000
    .section .bss
    .global L_SID_DELTA_DOMAIN
L_SID_DELTA_DOMAIN:
    .zero 136
    .section .data
    .global L_SID_DELTA_DOMAIN_INIT
L_SID_DELTA_DOMAIN_INIT:
    .quad 0x0
    .section .bss
    .global L_SID_DELTA_SITE
L_SID_DELTA_SITE:
    .zero 256
    .global L_SID_DEC_BUF
L_SID_DEC_BUF:
    .zero 192
    .global L_SID_VIS_HEADER
L_SID_VIS_HEADER:
    .zero 64
    .global L_SID_VIS_ARROW
L_SID_VIS_ARROW:
    .zero 48
    .global L_SID_VIS_NL
L_SID_VIS_NL:
...
L_sid_init_delta_domain:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_SID_DELTA_DOMAIN_INIT(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
    ...
    popq %rax
L_if_end_1:
    leaq L_SID_DELTA_DOMAIN(%rip), %rax
    pushq %rax
    movabsq $0x0, %rax
    pushq %rax
    movabsq $0x70, %rax
    ...
    pushq %rax
    popq %rax
    movb %al, L_SID_DELTA_DOMAIN_INIT(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sid_dependency_graph"
    .text
    .global sid_dependency_graph
    .seh_proc sid_dependency_graph
...
L_loop_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sid_transitive_closure"
    .text
    .global sid_transitive_closure
    .seh_proc sid_transitive_closure
...
L_if_end_11:
    ...
    popq %rax
L_if_end_13:
    movq L_SID_MAX_CLOSURE(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_41:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "sid_provenance_delta"
    .text
    .global sid_provenance_delta
    .seh_proc sid_provenance_delta
...
L_sid_init_vis_literals:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_SID_VIS_LIT_INIT(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_if_end_59:
    ...
    pushq %rax
    popq %rax
    movb %al, L_SID_VIS_LIT_INIT(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    .asciz "sid_visualize"
    .text
    .global sid_visualize
    .seh_proc sid_visualize
sid_visualize:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_63:
    subq $32, %rsp
    callq L_sid_init_vis_literals
    addq $32, %rsp
    movl %eax, %eax
    pushq %rax
    popq %rax
    movq L_SID_VIS_MAX_BYTES(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
