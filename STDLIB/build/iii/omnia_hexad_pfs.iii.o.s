...
L_if_end_11:
    ...
    .asciz "iii_hexad_pfs"
    .text
    .global iii_hexad_pfs
    .seh_proc iii_hexad_pfs
iii_hexad_pfs:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_13:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "iii_hexad_pfs_count"
    .text
    .global iii_hexad_pfs_count
    .seh_proc iii_hexad_pfs_count
iii_hexad_pfs_count:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "iii_hexad_pfs_kind"
    .text
    .global iii_hexad_pfs_kind
    .seh_proc iii_hexad_pfs_kind
iii_hexad_pfs_kind:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_15:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "iii_hexad_pfs_name"
    .text
    .global iii_hexad_pfs_name
    .seh_proc iii_hexad_pfs_name
iii_hexad_pfs_name:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
