...
L_LRU_ARENA:
    .zero 128
    .global L_LRU_KEYS_BASE
L_LRU_KEYS_BASE:
    .zero 128
    .global L_LRU_VALS_BASE
L_LRU_VALS_BASE:
    .zero 128
    .global L_LRU_PREV_BASE
L_LRU_PREV_BASE:
    .zero 128
    .global L_LRU_NEXT_BASE
L_LRU_NEXT_BASE:
    .zero 128
    .global L_LRU_OCCUP_BASE
L_LRU_OCCUP_BASE:
    .zero 128
    .global L_LRU_CAP
L_LRU_CAP:
...
L_if_end_1:
    ...
    movq -16(%rbp), %rax
    pushq %rax
    movl L_LRU_MAX_INSTANCES(%rip), %eax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
...
L_loop_end_31:
    ...
    popq %rax
    movq %rdx, (%rax,%rcx,8)
    leaq L_LRU_HEAD(%rip), %rax
    pushq %rax
    movl -32(%rbp), %eax
    pushq %rax
    movl L_LRU_NIL(%rip), %eax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
    movl %edx, (%rax,%rcx,4)
    leaq L_LRU_TAIL(%rip), %rax
    pushq %rax
    movl -32(%rbp), %eax
    pushq %rax
    movl L_LRU_NIL(%rip), %eax
...
L_if_end_77:
    ...
    .asciz "lru_debug_key"
    .text
    .global lru_debug_key
    .seh_proc lru_debug_key
lru_debug_key:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_79:
    ...
    .asciz "lru_debug_occ"
    .text
    .global lru_debug_occ
    .seh_proc lru_debug_occ
lru_debug_occ:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
