...
L_PR_SEAL2:
    .zero 256
    .section .iii.ring3,"n"
    .asciz "proof_resolve_equiv"
    .text
    .global proof_resolve_equiv
    .seh_proc proof_resolve_equiv
proof_resolve_equiv:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "proof_resolve_result"
    .text
    .global proof_resolve_result
    .seh_proc proof_resolve_result
proof_resolve_result:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_5:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "proof_resolve_seal"
    .text
    .global proof_resolve_seal
    .seh_proc proof_resolve_seal
proof_resolve_seal:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "proof_resolve_selftest"
    .text
    .global proof_resolve_selftest
    .seh_proc proof_resolve_selftest
proof_resolve_selftest:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_41:
    ...
    popq %rcx
    subq $32, %rsp
    callq resolver_set_force_diverge
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
