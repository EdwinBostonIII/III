...
L_FORM_PIPELINE:
    .quad 0x12
L_G_TRANSFORM_SLOT_FIRST:
    .quad 0x12
L_G_TRANSFORM_SLOT_LAST:
    .quad 0x29
L_G_TRANSFORM_COUNT:
    .quad 0x18
    .section .data
    .global L_g_transform_pattern_set
L_g_transform_pattern_set:
    .quad 0x0
    .global L_XFM_DOM_SITE
L_XFM_DOM_SITE:
    .byte 0x49
    .byte 0x49
    .byte 0x49
...
L_TX_OUT:
    .zero 256
    .section .iii.ring3,"n"
    .asciz "transform_pattern_set_init"
    .text
    .global transform_pattern_set_init
    .seh_proc transform_pattern_set_init
transform_pattern_set_init:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    popq %rax
L_if_end_1:
    movl L_G_TRANSFORM_SLOT_FIRST(%rip), %eax
    pushq %rax
    popq %rax
    movq %rax, -24(%rbp)
L_loop_top_2:
    movl -24(%rbp), %eax
    pushq %rax
    movl L_G_TRANSFORM_SLOT_LAST(%rip), %eax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
...
L_loop_end_3:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_g_transform_pattern_set(%rip)
    movq -16(%rbp), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "transform_pattern_set_get"
    .text
    .global transform_pattern_set_get
    .seh_proc transform_pattern_set_get
transform_pattern_set_get:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movq L_g_transform_pattern_set(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "transform_site_hash"
    .text
    .global transform_site_hash
    .seh_proc transform_site_hash
transform_site_hash:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_5:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "transform_pack"
    .text
    .global transform_pack
    .seh_proc transform_pack
transform_pack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "transform_unpack_dst"
    .text
    .global transform_unpack_dst
    .seh_proc transform_unpack_dst
transform_unpack_dst:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_if_end_13:
    ...
    popq %rcx
    subq $32, %rsp
    callq L_result_unwrap
    addq $32, %rsp
    pushq %rax
    popq %rax
    movq %rax, -56(%rbp)
    leaq L_TX_OUT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    movq -24(%rbp), %rax
...
L_if_end_19:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "transform_buffer"
    .text
    .global transform_buffer
    .seh_proc transform_buffer
transform_buffer:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
