...
L_CPE_N:
    ...
    .asciz "cpe_enumerate"
    .text
    .global cpe_enumerate
    .seh_proc cpe_enumerate
cpe_enumerate:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
