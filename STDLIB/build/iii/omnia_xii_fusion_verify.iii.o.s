...
L_xfv_null_compose:
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movl L_XFV_NULL_GROUND(%rip), %eax
    pushq %rax
    movzbq L_XFV_K06_COMPOSE(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    subq $32, %rsp
...
xfv_verify:
    ...
    subq $8, %rsp
    subq $32, %rsp
    callq L_xfv_null_compose
    addq $32, %rsp
    addq $8, %rsp
    movl %eax, %eax
    pushq %rax
    movzbq L_XFV_FCOMPOSE(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
...
L_if_end_7:
    ...
    subq $8, %rsp
    subq $32, %rsp
    callq L_xfv_null_then
    addq $32, %rsp
    addq $8, %rsp
    movl %eax, %eax
    pushq %rax
    movzbq L_XFV_FTHEN(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
