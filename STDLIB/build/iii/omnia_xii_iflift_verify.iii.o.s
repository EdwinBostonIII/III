...
xiv_verify:
    ...
    movabsq $0x5, %rax
    pushq %rax
    movzbq L_XIV_FTHEN(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    subq $32, %rsp
    callq L_xiv_prefix_ok
    addq $32, %rsp
    movzbq %al, %rax
    pushq %rax
    movabsq $0x1, %rax
