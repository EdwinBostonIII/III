...
L_if_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "xms_seal_digest"
    .text
    .global xms_seal_digest
    .seh_proc xms_seal_digest
xms_seal_digest:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "xms_run_terminal"
    .text
    .global xms_run_terminal
    .seh_proc xms_run_terminal
xms_run_terminal:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
xms_selftest:
    ...
    popq %rax
L_if_end_37:
    leaq L_XMS_DIG1(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
    subq $32, %rsp
    callq xms_seal_digest
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    popq %rax
    leaq L_XMS_DIG2(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rcx
