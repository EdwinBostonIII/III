...
L_XRV_FORM:
    .quad 0x1
    .section .data
    .global L_XRV_NOT_EXP
L_XRV_NOT_EXP:
    .long 0x1
    .long 0x0
    .long 0xffffffffffffffff
    .global L_XRV_AND_EXP
L_XRV_AND_EXP:
    .long 0xffffffffffffffff
    .long 0xffffffffffffffff
    .long 0xffffffffffffffff
...
L_loop_top_10:
    ...
    movslq -16(%rbp), %rax
    pushq %rax
    movzbq L_XRV_AND(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rdx
    popq %r8
    subq $32, %rsp
    callq L_xrv_eval_bin
    addq $32, %rsp
    movslq %eax, %rax
    pushq %rax
    leaq L_XRV_AND_EXP(%rip), %rax
    pushq %rax
    movq -40(%rbp), %rax
    pushq %rax
    popq %rcx
