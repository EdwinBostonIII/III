...
L_INSTANT_TICK:
    .zero 2048
    .global L_INSTANT_EPOCH
L_INSTANT_EPOCH:
    .zero 2048
    .global L_INSTANT_CAP
L_INSTANT_CAP:
    .zero 2048
...
L_if_end_9:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_init_epoch"
    .text
    .global L_instant_init_epoch
    .seh_proc L_instant_init_epoch
L_instant_init_epoch:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
    ...
    .seh_stackalloc 1024
    .seh_endprologue
    movzbq L_INSTANT_EPOCH_INITED(%rip), %rax
    pushq %rax
    movabsq $0x1, %rax
    pushq %rax
    popq %rcx
...
L_if_end_11:
    ...
    pushq %rax
    popq %rax
    movq %rax, L_INSTANT_PROCESS_EPOCH(%rip)
    movabsq $0x1, %rax
    pushq %rax
    popq %rax
    movb %al, L_INSTANT_EPOCH_INITED(%rip)
    movabsq $0x0, %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_seal_compute"
    .text
    .global L_instant_seal_compute
    .seh_proc L_instant_seal_compute
L_instant_seal_compute:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    .seh_setframe %rbp, 0
...
L_loop_end_19:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_now_sealed"
    .text
    .global instant_now_sealed
    .seh_proc instant_now_sealed
instant_now_sealed:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endprologue
    movq %rcx, -8(%rbp)
    movq L_INSTANT_RIGHT_TIME(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_25:
    ...
    .asciz "instant_epoch"
    .text
    .global instant_epoch
    .seh_proc instant_epoch
instant_epoch:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_27:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_seal_byte"
    .text
    .global instant_seal_byte
    .seh_proc instant_seal_byte
instant_seal_byte:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_31:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_verify"
    .text
    .global instant_verify
    .seh_proc instant_verify
instant_verify:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_loop_end_41:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "instant_diff_ticks"
    .text
    .global instant_diff_ticks
    .seh_proc instant_diff_ticks
instant_diff_ticks:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
