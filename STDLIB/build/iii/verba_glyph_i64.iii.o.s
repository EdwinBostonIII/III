...
L_GV3_FORM_I64:
    .quad 0x13
    .section .iii.ring3,"n"
    .asciz "glyph_i64_form_id"
    .text
    .global glyph_i64_form_id
    .seh_proc glyph_i64_form_id
glyph_i64_form_id:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_i64_pack"
    .text
    .global glyph_i64_pack
    .seh_proc glyph_i64_pack
glyph_i64_pack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_i64_unpack"
    .text
    .global glyph_i64_unpack
    .seh_proc glyph_i64_unpack
glyph_i64_unpack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_7:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_i64_validate"
    .text
    .global glyph_i64_validate
    .seh_proc glyph_i64_validate
glyph_i64_validate:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
