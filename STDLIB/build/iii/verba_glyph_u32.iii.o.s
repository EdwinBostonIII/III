...
L_GV3_FORM_U32:
    .quad 0x11
    .section .iii.ring3,"n"
    .asciz "glyph_u32_form_id"
    .text
    .global glyph_u32_form_id
    .seh_proc glyph_u32_form_id
glyph_u32_form_id:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_u32_pack"
    .text
    .global glyph_u32_pack
    .seh_proc glyph_u32_pack
glyph_u32_pack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_u32_unpack"
    .text
    .global glyph_u32_unpack
    .seh_proc glyph_u32_unpack
glyph_u32_unpack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_7:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_u32_validate"
    .text
    .global glyph_u32_validate
    .seh_proc glyph_u32_validate
glyph_u32_validate:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
