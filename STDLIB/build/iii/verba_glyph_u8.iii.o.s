...
L_GV3_FORM_U8:
    .quad 0x10
    .section .iii.ring3,"n"
    .asciz "glyph_u8_form_id"
    .text
    .global glyph_u8_form_id
    .seh_proc glyph_u8_form_id
glyph_u8_form_id:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
    ...
    .asciz "glyph_u8_pack"
    .text
    .global glyph_u8_pack
    .seh_proc glyph_u8_pack
glyph_u8_pack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_1:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_u8_unpack"
    .text
    .global glyph_u8_unpack
    .seh_proc glyph_u8_unpack
glyph_u8_unpack:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_7:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "glyph_u8_validate"
    .text
    .global glyph_u8_validate
    .seh_proc glyph_u8_validate
glyph_u8_validate:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
