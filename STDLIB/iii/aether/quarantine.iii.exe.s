...
L_QUAR_OK:
    .quad 0x0
    .global L_QUAR_E_FULL
L_QUAR_E_FULL:
    .quad 0xffffffffffffffff
    .global L_QUAR_E_BAD
L_QUAR_E_BAD:
    .quad 0xfffffffffffffffe
    .global L_QUAR_E_STATE
L_QUAR_E_STATE:
    .quad 0xfffffffffffffffd
    .global L_QUAR_E_BOUNDS
L_QUAR_E_BOUNDS:
    .quad 0xfffffffffffffffc
    .global L_QUAR_E_CAP
L_QUAR_E_CAP:
    .quad 0xfffffffffffffffb
    .global L_QUAR_E_WITNESS
L_QUAR_E_WITNESS:
    .quad 0xfffffffffffffffa
    .global L_QUAR_MAX_SLOTS
L_QUAR_MAX_SLOTS:
    .quad 0x100
    .global L_QUAR_MAX_JENT
L_QUAR_MAX_JENT:
    .quad 0x10000
    .global L_QUAR_DATA_AREA
L_QUAR_DATA_AREA:
    .quad 0x100000
    .global L_QUAR_UNDO_AREA
L_QUAR_UNDO_AREA:
    .quad 0x100000
    .global L_QUAR_SENT
L_QUAR_SENT:
    .quad 0xffffffff
    .global L_QUAR_WH_FAIL
L_QUAR_WH_FAIL:
    .quad 0xffffffffffffffff
    .global L_QUAR_STATE_OPEN
L_QUAR_STATE_OPEN:
    .quad 0x0
    .global L_QUAR_STATE_COMMIT
L_QUAR_STATE_COMMIT:
    .quad 0x1
    .global L_QUAR_STATE_ABORT
L_QUAR_STATE_ABORT:
    .quad 0x2
    .global L_QUAR_STATE_ROLLBACK
L_QUAR_STATE_ROLLBACK:
    .quad 0x3
    .global L_QUAR_STATE_INVALID
L_QUAR_STATE_INVALID:
    .quad 0xff
    .global L_QUAR_RIGHT_AMEND
L_QUAR_RIGHT_AMEND:
    .quad 0x4000
    .global L_QUAR_PILLAR
L_QUAR_PILLAR:
    .quad 0x1
    .section .bss
    .global L_QUAR_LIVE
...
L_QUAR_STATE:
    .zero 2048
    .global L_QUAR_REGION_BASE
L_QUAR_REGION_BASE:
    .zero 2048
    .global L_QUAR_REGION_LEN
L_QUAR_REGION_LEN:
    .zero 2048
    .global L_QUAR_JOUR_START
L_QUAR_JOUR_START:
    .zero 2048
    .global L_QUAR_JOUR_END
L_QUAR_JOUR_END:
    .zero 2048
    .global L_QUAR_UNDO_START
L_QUAR_UNDO_START:
    .zero 2048
    .global L_QUAR_UNDO_END
L_QUAR_UNDO_END:
    .zero 2048
    .global L_QUAR_ENTER_FRAG
L_QUAR_ENTER_FRAG:
    .zero 2048
    .global L_QUAR_COMMIT_FRAG
L_QUAR_COMMIT_FRAG:
    .zero 2048
    .global L_QUAR_ENTER_ID
L_QUAR_ENTER_ID:
    .zero 65536
    .global L_QUAR_COMMIT_ID
L_QUAR_COMMIT_ID:
    .zero 65536
    .global L_QUAR_JE_ADDR
L_QUAR_JE_ADDR:
    .zero 524288
    .global L_QUAR_JE_LEN
L_QUAR_JE_LEN:
    .zero 524288
    .global L_QUAR_JE_DATA_OFF
L_QUAR_JE_DATA_OFF:
    .zero 524288
    .global L_QUAR_UE_ADDR
L_QUAR_UE_ADDR:
    .zero 524288
    .global L_QUAR_UE_LEN
L_QUAR_UE_LEN:
    .zero 524288
    .global L_QUAR_UE_DATA_OFF
L_QUAR_UE_DATA_OFF:
    .zero 524288
    .global L_QUAR_DATA
L_QUAR_DATA:
...
L_QUAR_UNDO:
    .zero 8388608
    .section .data
    .global L_QUAR_JE_USED
L_QUAR_JE_USED:
    .quad 0x0
    .global L_QUAR_DATA_USED
L_QUAR_DATA_USED:
    .quad 0x0
    .global L_QUAR_UE_USED
L_QUAR_UE_USED:
    .quad 0x0
    .global L_QUAR_UNDO_USED
L_QUAR_UNDO_USED:
    .quad 0x0
    .section .bss
    .global L_QUAR_PRODUCER
L_QUAR_PRODUCER:
    .zero 256
    .global L_QUAR_OPID_ENTER
L_QUAR_OPID_ENTER:
    .zero 256
    .global L_QUAR_OPID_COMMIT
L_QUAR_OPID_COMMIT:
    .zero 256
    .global L_QUAR_OPID_ABORT
L_QUAR_OPID_ABORT:
    .zero 256
    .global L_QUAR_OPID_ROLLBACK
L_QUAR_OPID_ROLLBACK:
    .zero 256
    .section .data
    .global L_QUAR_INITED
L_QUAR_INITED:
    .quad 0x0
    .section .bss
    .global L_QUAR_DESC
...
L_QUAR_FID:
    .zero 256
    .global L_QUAR_SUMBUF
L_QUAR_SUMBUF:
    .zero 6291456
    .global L_QUAR_ABORTBUF
L_QUAR_ABORTBUF:
    .zero 512
    .global L_QUAR_KAT_REGION
L_QUAR_KAT_REGION:
    .zero 2048
    .global L_QUAR_KAT_OUT
L_QUAR_KAT_OUT:
    .zero 512
    .global L_QUAR_KAT_ID_E
L_QUAR_KAT_ID_E:
    .zero 256
    .global L_QUAR_KAT_ID_C
L_QUAR_KAT_ID_C:
    .zero 256
    .global L_QUAR_KAT_W3
L_QUAR_KAT_W3:
    .zero 64
    .section .iii.ring3,"n"
...
L_q_in_region:
    ...
    movq %rdx, -16(%rbp)
    movq %r8, -24(%rbp)
    leaq L_QUAR_REGION_BASE(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
    ...
    popq %rax
    movq %rax, -32(%rbp)
    leaq L_QUAR_REGION_LEN(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_q_resolve_byte:
    ...
    movq %rdx, -16(%rbp)
    movq %r8, -24(%rbp)
    leaq L_QUAR_JOUR_START(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_while_top_10:
    ...
    popq %rdx
    popq %r8
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=4 (16-aligned)  [MS x64 ABI §6.4]
    callq L_q_byte_in_entry
    addq $32, %rsp /* unshadow */
    movzbq %al, %rax  /* zero-extend u8 return */
    pushq %rax
    popq %rax
    movq %rax, -80(%rbp)
    movq -80(%rbp), %rax
...
L_q_capture_undo:
    ...
    popq %rax
    movq %rax, -24(%rbp)
    leaq L_QUAR_UNDO_START(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    movl L_QUAR_UE_USED(%rip), %eax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
...
L_if_end_29:
    ...
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=4 (16-aligned)  [MS x64 ABI §6.4]
    callq L_q_capture_one
    addq $32, %rsp /* unshadow */
    movslq %eax, %rax  /* sign-extend i32 return */
    pushq %rax
    popq %rax
    movq $0, %rax
    pushq %rax
...
L_q_capture_one:
    ...
    popq %rax
    movq %rdx, (%rax,%rcx,8)
    leaq L_QUAR_UE_DATA_OFF(%rip), %rax
    pushq %rax
    movq -32(%rbp), %rax
    pushq %rax
    movl L_QUAR_UNDO_USED(%rip), %eax
...
L_while_end_37:
    ...
    pushq %rax
    popq %rax
    movl %eax, %eax  /* zero-extend low32 */
    pushq %rax
    popq %rcx
    popq %rax
    addq %rcx, %rax
...
L_while_top_52:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movzbq L_QUAR_STATE_INVALID(%rip), %rax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
...
L_while_end_53:
    ...
    pushq %rax
    popq %rax
    leaq L_QUAR_OPID_ENTER(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    leaq L_QUAR_OPID_COMMIT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    leaq L_QUAR_OPID_ABORT(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    pushq %rax
    popq %rax
    leaq L_QUAR_OPID_ROLLBACK(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
...
q_enter:
    ...
    popq %rax
L_if_end_55:
    movq L_QUAR_RIGHT_AMEND(%rip), %rax
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rcx
...
L_if_end_57:
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=4 (16-aligned)  [MS x64 ABI §6.4]
    callq L_q_alloc_slot
    addq $32, %rsp /* unshadow */
    movl %eax, %eax  /* zero-extend u32 return */
    pushq %rax
    popq %rax
    movq %rax, -32(%rbp)
    movq -32(%rbp), %rax
...
L_if_end_59:
    ...
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=4 (16-aligned)  [MS x64 ABI §6.4]
    callq L_q_build_desc
    addq $32, %rsp /* unshadow */
    movslq %eax, %rax  /* sign-extend i32 return */
    pushq %rax
    popq %rax
    leaq L_QUAR_IN_C(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
    ...
    popq %r9
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=12 (16-aligned)  [MS x64 ABI §6.4]
    callq wh_publish
    addq $32, %rsp /* unshadow */
    addq $64, %rsp /* discard stack args */
    pushq %rax
    popq %rax
    movq %rax, -40(%rbp)
    movq -40(%rbp), %rax
    pushq %rax
    movq L_QUAR_WH_FAIL(%rip), %rax
    pushq %rax
    popq %rcx
    popq %rax
    cmpq %rcx, %rax
    ...
    popq %rax
L_if_end_61:
    leaq L_QUAR_ENTER_FRAG(%rip), %rax
    pushq %rax
    movq -32(%rbp), %rax
    pushq %rax
    movq -40(%rbp), %rax
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "q_journal_write"
    .text
    .global q_journal_write
    .seh_proc q_journal_write
q_journal_write:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_67:
    ...
    testq %rax, %rax
    jz L_if_end_69
    movslq L_QUAR_E_BOUNDS(%rip), %rax
    pushq %rax
    popq %rax
    movq %rbp, %rsp
    popq %rbp
...
L_while_end_75:
    ...
    .seh_endproc
    .section .iii.ring3,"n"
    .asciz "q_journal_read"
    .text
    .global q_journal_read
    .seh_proc q_journal_read
q_journal_read:
    pushq %rbp
    .seh_pushreg %rbp
    movq %rsp, %rbp
...
L_if_end_95:
    ...
    movq -16(%rbp), %rax
    pushq %rax
    movzbq L_QUAR_STATE_COMMIT(%rip), %rax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
    ...
    popq %rcx
    subq $32, %rsp /* MS x64 §6.4.4 shadow */
    # ABI-OK: pre-CALL slots=8 (16-aligned)  [MS x64 ABI §6.4]
    callq L_q_enter_id_ptr
    addq $32, %rsp /* unshadow */
    pushq %rax
    movzwq L_QUAR_PILLAR(%rip), %rax
    ...
    popq %rax
L_if_end_97:
    leaq L_QUAR_COMMIT_FRAG(%rip), %rax
    pushq %rax
    movq -16(%rbp), %rax
    pushq %rax
    movq -48(%rbp), %rax
...
L_if_end_103:
    ...
    movq -8(%rbp), %rax
    pushq %rax
    movzbq L_QUAR_STATE_ABORT(%rip), %rax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
...
L_if_end_111:
    ...
    movq -16(%rbp), %rax
    pushq %rax
    movzbq L_QUAR_STATE_ROLLBACK(%rip), %rax
    pushq %rax
    popq %rdx
    popq %rcx
    popq %rax
...
q_selftest:
    ...
    popq %rax
    movq %rax, -8(%rbp)
    leaq L_QUAR_KAT_REGION(%rip), %rax
    pushq %rax
    popq %rax
    pushq %rax
    popq %rax
