...
MODS="mech fourbar sturm sqrt_sum_sign kfield cyclotomic_se3 q23_sign verb_geom ui_raster ui_present ui_win"
...
gcc "$O/mech.o" "$O/fourbar.o" "$O/sturm.o" "$O/sqrt_sum_sign.o" "$O/kfield.o" \
    ...
    "$O/ui_raster.o" "$O/ui_present.o" "$O/ui_win.o" \
    "$LIB" -lkernel32 -luser32 -lgdi32 -o "$III/mech.exe" 2>"$O/link.log" \
