...
fail=0
for t in test_encode test_vex test_spine test_reloc test_store test_lea test_unknown test_call test_cmp test_branch test_sibcall test_sib test_sib_disp test_movzx_sib test_relax_back test_relax_cascade; do
